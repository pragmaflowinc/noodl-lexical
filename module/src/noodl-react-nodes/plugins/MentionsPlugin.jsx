...
const LookupService = {
  search(arr, string, callback) {
    setTimeout(() => {
      const results = arr.filter((mention) =>
...
function useMentionLookupService(mentionables, mentionString) {
...
function NewMentionsPlugin(props) {
  const [editor] = useLexicalComposerContext()

  const [queryString, setQueryString] = useState(null)

  const results = useMentionLookupService(props.mentionables || ['Steven'], queryString)
